...
Page({
  ...
  getOrderList: function () {
    ...
    app.util.request({
      url: 'entry/ewei_shopv2/mobile&r=groups.orders.get_list',
      method: 'GET',
      data: {
        page: that.data.page,
      ...
      success: function (e) {
        if (e.confirm) {
          ...
          app.util.getUserInfo(function () {
            app.util.request({
              url: 'entry/ewei_shopv2/mobile&r=groups.orders.finish',
              method: 'GET',
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          app.util.getUserInfo(function () {
            app.util.request({
              url: 'entry/ewei_shopv2/mobile&r=groups.orders.cancel',
              method: 'GET',
    ...
    wx.showModal({
      ...
      success: function (re) {
        if (re.confirm) {
          ...
          app.util.getUserInfo(function () {
            app.util.request({
              url: 'entry/ewei_shopv2/mobile&r=groups.orders.delete',
              method: 'GET',
